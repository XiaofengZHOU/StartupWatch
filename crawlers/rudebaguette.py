...
class CrawlerRudebaguette:
    def __init__(self, number_of_pages_to_crawl, silent=False):
        self.pages = []
        self.articles = []
        self.silent = silent
        self.name = "Rudebaguette"
        base_url = "http://www.rudebaguette.com/page/"
        self.relative_url_origin = "http://www.rudebaguette.com"
    ...
    def crawl(self):
        ...
        for idx, page in enumerate(self.pages):
            ...
            try:
                ...
                blocks = soup.select(".post, .headlinelarge, .headlinesmall")  # article_selector
                for block in blocks:
                    # article_type_text = ""
                    ...
                    link = block.select_one("h2 a")["href"]  # url
                ...
                print("Impossible de crawler Rude Baguette : Erreur "+str(e))
                return
            self.log("Rude Baguette crawling at " + str(((idx + 1) / pages_length) * 100) + "%")
